...
load_and_insert('stop_times', 'gtfs\stop_times1.csv');
load_and_insert('stop_times', 'gtfs\stop_times2.csv');
load_and_insert('stop_times', 'gtfs\stop_times3.csv');
load_and_insert('stop_times', 'gtfs\stop_times4.csv');
load_and_insert('stop_times', 'gtfs\stop_times5.csv');
load_and_insert('stop_times', 'gtfs\stop_times6.csv');
load_and_insert('stop_times', 'gtfs\stop_times7.csv');
